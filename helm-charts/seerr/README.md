...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: sha-bde322d](https://img.shields.io/badge/AppVersion-sha-bde322d-informational?style=flat-square)
...
```bash
helm upgrade --install seerr k8s-mediaserver-operator/seerr \
  -n seerr --create-namespace \
  -f values.yaml
```
