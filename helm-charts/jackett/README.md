...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.24.338](https://img.shields.io/badge/AppVersion-0.24.338-informational?style=flat-square)
...
```bash
helm upgrade --install jackett k8s-mediaserver-operator/jackett \
  -n jackett --create-namespace \
  -f values.yaml
```
